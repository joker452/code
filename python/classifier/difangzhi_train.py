...
def train():
    logger = logging.getLogger('difangzhi-classifier::train')
    logger.info('--- Running difangzhi-classifier Training ---')
    ...
    # load dataset
    logger.info('Loading dataset difangzhi')
    char_class = 5601
    train_set = torchvision.datasets.ImageFolder('/data2/dengbowen/train',
