...
def parse_args():
    ...
    parser.add_argument('-fold', default=4, help='which fold to use', type=int)
    ...
    # change: turn off augment
    parser.add_argument('-augment', default=0, help='use augmentation', type=int)
    ...
    # Model checkpointing
    parser.add_argument('-eval_every', default=140, help='How often to test on validation set', type=int)
    ...
    parser.add_argument('-score_threshold', default=0.1, help='threshold using box scores', type=float)
    ...
    # Visualization
    parser.add_argument('-print_every', default=2, help='How often to print the latest images training loss.', type=int)
    ...
    parser.add_argument('-gpu', default=2, help='which gpu to use.', type=int)
