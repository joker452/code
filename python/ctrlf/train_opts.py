import argparse
import easydict
# change remove all items relevant to embedding
def parse_args():
    ...
    parser.add_argument('-mid_objectness_weight', default=0.5, help='Weight for box classification in the RPN', type=float)
    parser.add_argument('-end_box_reg_weight', default=0.1, help='Weight for box regression in the recognition network', type=float)
    parser.add_argument('-end_objectness_weight', default=0.5, help='Weight for box classification in the recognition network', type=float)
    ...
    parser.add_argument('-dtp_train', default=1, help='use dtp while training', type=int)
    ...
    parser.add_argument('-score_nms_overlap', default=0.6, help='NMS overlap using box scores', type=float)
    parser.add_argument('-score_threshold', default=0.65, help='threshold using box scores', type=float)
    ...
    # Visualization
    parser.add_argument('-print_every', default=10, help='How often to print the latest images training loss.', type=int)
    ...
    # change default not eval first
    parser.add_argument('-eval_first_iteration', default=0, help='evaluate on first iteration? 1 = do, 0 = dont.', type=int)
