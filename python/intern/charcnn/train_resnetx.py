...
import torch.optim
from datasets.casia_resnetx import CASIA
...
def train():
    ...
    parser.add_argument('--max_epoch', '-epoch', type=int, default=30, help='The number of max epoch while training. \
                        Default: 100')
    parser.add_argument('--batch_size', '-is', type=int, default=32, help='The batch size of the data. Default: 32')
    ...
    # initialize network, optimizer, scheduler and loss
    ...
    if args.gpu_id and torch.cuda.device_count() > 1:
