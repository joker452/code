...
class CASIA(Dataset):
    ...
    def __init__(self, image_dir, label_dir, label_files, char_class):
        ...
        self.transforms = transforms.Compose([transforms.Resize((108, 108)), transforms.ToTensor()])

    @staticmethod
    def get_crop_image(img_path, img_name):
        ...
        try:
            ...
            # one or two character images recovered from the dataset may contain nothing
        ...
        h, w = img.shape
        img_bg = np.full((120, 120), 255, dtype='uint8')
    ...
    def __getitem__(self, index):
        image = self.get_crop_image(self.image_dir, self.image_list[index])
