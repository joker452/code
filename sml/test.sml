...
val f = careful_player;
val f1 = careful_player1;

f(#Hearts number,80);
f1(#Hearts number,80) ;
f((Spades,Queen)::(#Clubs number),100);
f1((Spades,Queen)::(#Clubs number),100) ;
f((#Hearts number)@[(Clubs,Queen)],664);
f1((#Hearts number)@[(Clubs,Queen)],664);
f(shuffled,400);
f1(shuffled,400) ;
