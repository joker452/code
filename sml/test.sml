...
fun compare(x: (int * int * int), y: (int * int * int)) =
    if #1 x = #1 y
    then if #2 x = #2 y
	 then #3 x > #3 y
	 else #2 x > #2 y
...
val test122 = ListMergeSort.sort(compare) (dates_in_months_challenge([(2012,2,28),(2013,12,1),(2011,3,31),
                (2011,4,28)], [2,3,4])) = ListMergeSort.sort(compare) [(2012,2,28),(2011,3,31),(2011,4,28)]
val test123 = ListMergeSort.sort(compare) (dates_in_months_challenge ([(2012,2,28),(2013,12,1),(2011,3,31),
                (2011,4,28)], [2,3,4,3,2])) = ListMergeSort.sort(compare) [(2012,2,28),(2011,3,31),(2011,4,28)]
