...
val test118 = all_except_option ("string", ["string"]) = SOME []
val test119 = all_except_option ("string", ["string2"]) = NONE
val test120 = all_except_option ("string", ["string", "string2"]) 
    = SOME ["string2"]
val test121 = all_except_option ("string", ["string", "string2", "string3"]) 
