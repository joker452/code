...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps powers-of-two 3) (list 2 4 8) "stream-for-n-steps test")
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero powers-of-two) 2) (list (cons 0 2) (cons 0 4)) "stream-add-zero test")
